                                     ...
                                     hmac_channel_list_stru *pst_chan_info)
{
    switch (en_bandwidth) {
        ...
        case WLAN_BAND_WIDTH_80PLUSPLUS:
            pst_chan_info->ul_channels = 4; /* 4???? */
            pst_chan_info->ast_channels[0] = g_ast_freq_map_5g[uc_pri20_channel_idx]; /* ??20???????? */
            pst_chan_info->ast_channels[1] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1]; /* ??20????+1 */
            /* ast_channels 2??3byte??????40????+1 */
        ...
        case WLAN_BAND_WIDTH_80PLUSMINUS:
            pst_chan_info->ul_channels = 4; /* 4???? */
            /* ast_channels 0??1byte??????40????-1??g_ast_freq_map_5g[uc_pri20_channel_idx]????2?????? */
            pst_chan_info->ast_channels[0] = g_ast_freq_map_5g[uc_pri20_channel_idx - 2];
            pst_chan_info->ast_channels[1] = g_ast_freq_map_5g[uc_pri20_channel_idx - 1];
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx]; /* ast_channels[2]????20???????? */
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1]; /* ast_channels[3]??20????+1 */
            break;

        case WLAN_BAND_WIDTH_80MINUSPLUS:
            pst_chan_info->ul_channels = 4; /* 4???? */
            pst_chan_info->ast_channels[0] = g_ast_freq_map_5g[uc_pri20_channel_idx - 1]; /* ??20????-1 */
            pst_chan_info->ast_channels[1] = g_ast_freq_map_5g[uc_pri20_channel_idx]; /* ??20???????? */
            /* ast_channels 2??3byte??????40????+1 */
        ...
        case WLAN_BAND_WIDTH_80MINUSMINUS:
            pst_chan_info->ul_channels = 4; /* 4???? */
            /* ast_channels 0??1byte??????40????-1??g_ast_freq_map_5g[uc_pri20_channel_idx]????3?????? */
            ...
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx - 1]; /* ast_channels[2]??20????-1 */
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx]; /* ast_channels[3]????20???????? */
            break;
