...
STATIC ps_core_msg_handler g_ps_core_msg_handle[MSG_BUTT] = {
    ps_exe_sys_func,             // SYS_MSG = 0x00,         ????????????
    ps_recv_no_sepreated_data,   // BT_MSG = 0x01,          BT????????
    ps_recv_sepreated_data,      // GNSS_FIRST_MSG = 0x02,  GNSS????????????????????????
    ps_recv_sepreated_data,      // GNSS_COMMON_MSG = 0x03, GNSS??????????????????????
    ps_recv_sepreated_data,      // GNSS_LAST_MSG = 0x04,   GNSS??????????????????????????
    ps_recv_sepreated_data,      // FM_FIRST_MSG = 0x05,    FM????????????????????????
    ps_recv_sepreated_data,      // FM_COMMON_MSG = 0x06,   FM??????????????????????
    ps_recv_sepreated_data,      // FM_LAST_MSG = 0x07,     FM??????????????????????????
    ps_recv_sepreated_data,      // IR_FIRST_MSG = 0x08,    ????????????????????????????
    ps_recv_sepreated_data,      // IR_COMMON_MSG = 0x09,   ??????????????????????????
    ps_recv_sepreated_data,      // IR_LAST_MSG = 0x0A,     ??????????????????????????????
    ps_recv_sepreated_data,      // NFC_FIRST_MSG = 0x0B,   NFC????????????????????????
    ps_recv_sepreated_data,      // NFC_COMMON_MSG = 0x0C,  NFC??????????????????????
    ps_recv_sepreated_data,      // NFC_LAST_MSG = 0x0D,    NFC??????????????????????????
    ps_recv_debug_data,          // OML_MSG = 0x0E,         ????????????
    ps_recv_mem_dump_size_data,  // MEM_DUMP_SIZE = 0x0f,   bfgx??????????dump??mem????????
    ps_recv_mem_dump_data,       // MEM_DUMP = 0x10,        bfgx????????????dump????
    NULL,                        // WIFI_MEM_DUMP = 0x11,   UART READ WIFI MEM??????dump????
    NULL,                        // BFGX_CALI_MSG = 0x12,   BFGX ????????????
};
