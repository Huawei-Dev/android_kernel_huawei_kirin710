...
{
	static const unsigned char keystore_hash[32] = {0x40, 0xDE, 0xEE, 0xEB, 0xAE, 0x5F, 0x2E, 0xD1,
						0x71, 0xDD, 0xAF, 0xB3, 0x74, 0x1A, 0x39, 0x5C,
						0xDC, 0x38, 0x47, 0x61, 0xE8, 0x07, 0xB4, 0xA5,
						0x63, 0xDD, 0x6B, 0xBE, 0x2B, 0xFA, 0x8E, 0x7C};

	static const unsigned char gatekeeper_hash[32] = {0x6C, 0x19, 0xE8, 0x30, 0x33, 0x24, 0x15, 0x21,
						0x42, 0x15, 0x6A, 0x93, 0xAC, 0x47, 0xCC, 0x1E,
						0x41, 0x53, 0x92, 0x6D, 0x4A, 0x96, 0x7D, 0x6D,
						0x0B, 0xEF, 0xEC, 0x6B, 0x85, 0x51, 0xA3, 0xEB};

	static const unsigned char fingerprint_hash[32] = {0xBC, 0x98, 0x4F, 0xC6, 0x6D, 0x3F, 0x27, 0x3A,
						0xE2, 0x3F, 0x21, 0x01, 0xEF, 0x5E, 0x7A, 0xA9,
						0x74, 0x53, 0xEF, 0xBC, 0x9C, 0xB2, 0x85, 0xE6,
						0xC1, 0x7B, 0xD4, 0x40, 0x3D, 0xB2, 0x6B, 0x9C};
	
	static const unsigned char aptouch_hash[32] = {0x4B, 0xB5, 0xF2, 0x60, 0xBD, 0xB5, 0xE9, 0x19,
						0x1E, 0xCE, 0x86, 0x7E, 0xBD, 0xAA, 0xED, 0xC7,
						0x51, 0x79, 0x1D, 0xD6, 0xA6, 0x22, 0x76, 0x02,
						0xC7, 0xE8, 0xD0, 0x80, 0x22, 0xB1, 0x55, 0x8E};

	static const unsigned char omx_hash[32] = {0xC6, 0xB0, 0x28, 0x8D, 0x85, 0xBE, 0x61, 0x7A,
						0x27, 0xC1, 0x0D, 0xD3, 0x44, 0x9A, 0xAE, 0x0A,
						0x33, 0x79, 0xB3, 0xA9, 0xAD, 0x8B, 0x4D, 0xBB,
						0x8F, 0x0B, 0x4E, 0x21, 0x62, 0x98, 0x15, 0x79};

	//TC_NS_OpenSession try to hash for /vendor/bin/hw/android.hardware.drm@1.2-service.widevine
	static const unsigned char widevine_hash[32] = {0x29, 0x51, 0xB9, 0xC7, 0xCD, 0x22, 0x9F, 0x0E,
						0x7B, 0x83, 0x55, 0xC5, 0xE9, 0x0F, 0x93, 0xEC,
						0x4B, 0xDB, 0x01, 0xC7, 0x77, 0xAA, 0xB1, 0x63,
						0x89, 0xDA, 0x1D, 0x1A, 0xAE, 0x7B, 0x90, 0xEB};

	static const unsigned char graphics_allocator_hash[32] = {0xE5, 0xC3, 0x73, 0x12, 0x46, 0x45, 0xE1, 0xBE,
						0xC9, 0xBA, 0x91, 0xED, 0x80, 0x20, 0xB8, 0xB4,
						0x6F, 0xC7, 0x5D, 0xC5, 0xC2, 0x96, 0xEB, 0x09,
						0x9A, 0xC0, 0x71, 0xB0, 0x58, 0x46, 0x8A, 0x21};

	static const unsigned char graphics_composer_hash[32] = {0x90, 0x80, 0x91, 0x82, 0x38, 0x15, 0xF2, 0x60,
						0xDC, 0x27, 0x5D, 0x56, 0x57, 0x04, 0x11, 0xC7,
						0x0F, 0x8C, 0x6B, 0x43, 0x0E, 0x9B, 0x77, 0xDA,
						0x4A, 0xED, 0x3B, 0xD7, 0xC4, 0xC8, 0x3F, 0x05};
	...
	} else if (!strcmp(my_pkname, "/vendor/bin/hw/android.hardware.drm@1.2-service.widevine")) {
